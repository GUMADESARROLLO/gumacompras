...
<!--fileupload-->
<!--pass source-->
<input type="hidden" name="source" value="<?php echo e(request('source')); ?>"><?php /**PATH E:\Wamp\www\GumaCompras\application\resources\views/pages/files/components/modals/add-edit-inc.blade.php ENDPATH**/ ?>