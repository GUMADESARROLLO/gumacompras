<div class="row">
    ...
    <div class="col-lg-12">
        <div class="form-group row">
            <div class="col-12">
                <input name="milestonecategory_color" type="radio" id="radio_default" value="default"
                    <?php echo e($page['default_color'] ?? ''); ?> <?php echo e(runtimePreChecked2('default', $milestone->milestonecategory_color ?? '')); ?>
            ...
            <!--hidden-->
            <input type="hidden" name="milestonecategory_color" id="milestonecategory_color" value="">

        </div>
    </div

<?php /**PATH E:\Wamp\www\GumaCompras\application\resources\views/pages/settings/sections/milestones/modals/add-edit-inc.blade.php ENDPATH**/ ?>